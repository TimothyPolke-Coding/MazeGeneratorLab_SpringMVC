...
public class Puzzle extends BufferedImage{
	...
	public boolean forwardMotionNorth(){
		boolean failed=true;
		try{
	...
	public boolean forwardMotionSouth(){
		boolean failed=true;
		try{
	...
	public boolean forwardMotionWest(){
		boolean failed=true;
		try{
	...
	public boolean forwardMotionEast(){
		boolean failed=true;
		try{
	...
	public boolean backwardMotionNorth(){
		boolean match=false;
	...
	public boolean backwardMotionSouth(){
		boolean match=false;
	...
	public boolean backwardMotionWest(){
		boolean match=false;
	...
	public boolean backwardMotionEast(){
		boolean match=false;
